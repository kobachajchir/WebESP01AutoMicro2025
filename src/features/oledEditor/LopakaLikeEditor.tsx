                  ...
                  >
                    ...
                    >
                      <div>
                        ...
                        <div className="text-xs uppercase text-slate-400">{object.kind}</div>
                      </div>
        ...
        <div className="flex min-w-0 flex-col gap-4">
          <div className="app-panel-strong flex flex-wrap items-center gap-2 p-3">
            ...
            <div className="ml-auto flex items-center gap-2">
              <div className="flex items-center gap-2 rounded-full border border-white/10 bg-slate-950/35 px-2 py-1">
                <ToolbarIconButton
                  label="Alejar"
                  onClick={() =>
                    editor.setViewport({
                ...
                <div className="min-w-10 text-center text-xs font-black uppercase tracking-[0.18em] text-slate-200">
          ...
          <div className="app-panel-strong flex flex-col gap-4 p-4">
            <div className="flex items-center justify-between gap-3">
              <div>
                <h2 className="text-xl font-black text-white">Canvas</h2>
              </div>
              <div className="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs font-semibold uppercase text-slate-300">
                {getToolLabel(editor.state.activeTool)}
              </div>
            </div>

            <div className="overflow-auto rounded-md border border-white/10 bg-slate-950/60 p-4">
              <div
                ref={stageRef}
                className="relative mx-auto rounded-md border border-cyan-300/20 bg-slate-950 shadow-[0_0_0_1px_rgba(34,211,238,0.08)]"
                style={{
        ...
        <div className="grid gap-4 xl:grid-cols-[300px_minmax(0,1fr)]">
          <div className="flex flex-col gap-3">
            {(
              ...
              <label
                key={key}
                className="flex items-center justify-between rounded-md border border-white/10 bg-slate-950/35 px-3 py-2 text-sm text-slate-200"
              >
                <span>{label}</span>
                <input
                  type="checkbox"
          ...
          <div
            ref={codePanelRef}
            className="overflow-auto rounded-md border border-white/10 bg-slate-950/55 p-4"
          >
      ...
      >
        <div className="flex flex-col gap-4">
          <div>
            ...
            <h2 className="text-2xl font-black text-white">Libreria draft</h2>
            ...
            {assetList.map((asset) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-center rounded-md border border-white/10 bg-slate-950/60 p-3">
                    <BitmapMiniPreview
                      width={asset.width}
                      height={asset.height}
