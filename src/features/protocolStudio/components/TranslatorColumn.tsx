...
PING`}
 ...
 <span className="pointer-events-none absolute inset-0 flex items-center justify-center bg-[var(--ui-bg-0)]/75 opacity-0 transition-opacity duration-200 group-hover:opacity-100 group-focus-visible:opacity-100">
 ...
 <div className="flex flex-wrap gap-3 text-xs text-[var(--ui-muted)]">
 <span className="inline-flex items-center gap-2">
 <span className="size-3 rounded-sm border border-[var(--ui-ring)] bg-[var(--ui-panel)]" />
 ...
 {scanResult ? (
 <div className="space-y-4">
 <article className="rounded-xl border border-[var(--ui-ring)] bg-[var(--ui-bg-0)]/50 p-4">
 <div className="flex items-center justify-between gap-3">
 <h3 className="font-semibold text-[var(--ui-text)]">Resumen del bloque</h3>
 <span className="font-mono text-sm text-[var(--ui-muted)]">{scanResult.totalBytes} bytes</span>
 </div>
 ...
 <>
 <div className="text-[11px] font-semibold uppercase tracking-[0.2em] text-[var(--ui-text)]">
 ...
 return (
 <article key={`valid-${item.offset}`} className="rounded-xl border border-[var(--ui-ring)] bg-[var(--ui-bg-0)]/50 p-4">
 ...
 <div className="mt-3 space-y-1 text-sm text-[var(--ui-muted)]">
 <p>
 CMD: <span className="font-mono text-[var(--ui-text)]">{item.analysis.cmdHex}</span> -{" "}
 <span className="font-semibold text-[var(--ui-text)]">{item.analysis.name}</span>
 </p>
 ...
 <div className="rounded-xl border border-[var(--ui-ring)] bg-[var(--ui-bg-0)]/70 p-3 font-mono text-sm text-[var(--ui-text)]">
 ...
 <article key={`invalid-${item.offset}`} className="rounded-xl border border-[var(--ui-ring)] bg-[var(--ui-bg-0)]/50 p-4">
 <div className="flex flex-wrap items-center justify-between gap-3">
 <h3 className="font-semibold text-[var(--ui-text)]">
 ...
 <p className="mt-3 text-sm text-[var(--ui-muted)]">Motivo: {item.reason}</p>
 <div className="mt-4">
 ...
 <article key={`gap-${gap.start}-${gap.end}`} className="rounded-xl border border-[var(--ui-ring)] bg-[var(--ui-bg-0)]/50 p-4">
 <div className="flex flex-wrap items-center justify-between gap-3">
 <h3 className="font-semibold text-[var(--ui-text)]">
 ...
 <p className="mt-3 text-sm text-[var(--ui-muted)]">{gap.note}</p>
 <p className="mt-3 text-sm text-[var(--ui-muted)]">
 ASCII aprox: <span className="font-mono text-[var(--ui-text)]">{asciiPreview(gap.bytes, 100)}</span>
 </p>
 <div className="mt-4">
...
function StreamSegmentBody({ segment }: { segment: StreamSegment }) {
 ...
 className="inline-flex min-w-9 items-center justify-center rounded-md border border-[var(--ui-ring)] bg-[var(--ui-panel)] px-2 py-1 font-mono text-xs font-semibold"
 >
 {h2(byte)}
 </span>
 ))}
...
function AnalysisDetailCard({
 ...
 return (
 <article className="relative overflow-hidden rounded-xl border border-sky-300/25 bg-[var(--ui-bg-0)]/70 p-4 shadow-sm ring-1 ring-rose-300/10">
 ...
 <h2 className="text-lg font-bold text-[var(--ui-text)]">Analisis a detalle de {detailName}</h2>
...
function PayloadValue({
 ...
 <div className="text-xs font-medium uppercase tracking-[0.18em] text-[var(--ui-text)]">{label}</div>
 <CopyPill copyKey={copyKey} value={copyValue} copiedKey={copiedKey} onCopy={onCopy} />
 </div>
 <div className="min-h-12 rounded-xl border border-[var(--ui-ring)] bg-[var(--ui-bg-0)]/70 p-3 font-mono text-sm text-[var(--ui-text)]">
 {value}
 </div>
 </div>
 );
...
function CollapsibleDetailSection({
 ...
 return (
 <section className="rounded-xl border border-[var(--ui-ring)] bg-[var(--ui-bg-0)]/45 p-3">
 <button
 type="button"
 className="flex w-full items-center justify-between gap-3 text-left text-sm font-bold uppercase text-[var(--ui-text)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-300/50"
 onClick={onToggle}
...
function SummaryMetric({ label, value, tone }: { label: string; value: number; tone: "emerald" | "amber" | "rose" }) {
 ...
 return (
 <div className="rounded-xl border border-[var(--ui-ring)] bg-[var(--ui-panel)] p-3">
 <div className="text-[10px] uppercase tracking-[0.18em] text-[var(--ui-text)]">{label}</div>
