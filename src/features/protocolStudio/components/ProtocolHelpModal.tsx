...
export function ProtocolHelpModal({ isOpen, onClose }: ProtocolHelpModalProps) {
 ...
 <h2 className="mb-4 text-2xl font-bold text-[var(--ui-text)]">UNER Studio</h2>
 <p className="mb-3 text-[var(--ui-ink)] leading-relaxed">
 ...
 <ul className="mb-4 space-y-2 text-[var(--ui-ink)]">
 ...
 <div className="rounded-xl bg-[var(--ui-panel)] p-3 text-xs text-[var(--ui-ink)] ring-1 ring-[var(--ui-ring)]">
 <p className="m-0">
