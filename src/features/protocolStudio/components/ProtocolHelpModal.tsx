  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} closeOnOverlayClick={false}>
      ...
      <ul className="mb-4 space-y-2 text-black">
        ...
        <li><span className="font-semibold">Detalle por bloque:</span> si el escaneo detecta un solo frame valido, el analisis detallado se abre automaticamente. Si hay varios, pasa el mouse sobre cada frame del mapa y usa <code>Ver detalles</code> para abrir el bloque que quieras inspeccionar.</li>
