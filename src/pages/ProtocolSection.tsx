...
export default function ProtocolSection() {
 ...
 return (
 <section className="protocol-dashboard-shell min-h-screen w-full text-[var(--ui-text)]">
 <div className="protocol-dashboard-frame mx-auto flex w-full max-w-[2400px] flex-col gap-6 p-6">
 <PageHeader
 ...
 <p className="m-0">
 <span className="font-semibold text-[var(--ui-text)]">Tip:</span> el flujo
