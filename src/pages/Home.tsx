...
const Home: React.FC = () => {
 ...
 {(["IDLE", "FOLLOW", "TEST", "GOTO"] as SelectableCarMode[])
 ...
 <div>
 <h3 className="font-bold text-[var(--ui-text)]">Port forwarding UNER</h3>
 ...
 <div>
 <h3 className="font-bold text-[var(--ui-text)]">Watchdog de heartbeat</h3>
 ...
 <div className="app-panel mb-4 p-3 text-sm text-[var(--ui-muted)]">
 Intentos restantes:{" "}
 ...
 className="mb-2 block text-sm text-[var(--ui-text)]"
 >
 ...
 <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
 <div>
 <h3 className="font-bold text-[var(--ui-text)]">Modo desarrollador</h3>
 <p className="text-sm text-[var(--ui-muted)]">
 ...
 <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
 <div>
 <h3 className="font-bold text-[var(--ui-text)]">PIN de acceso</h3>
 <p className="mt-1 max-w-2xl text-sm text-[var(--ui-muted)]">
 ...
 <h2 className="text-3xl font-black text-[var(--ui-text)]">
 {pinStep === "validate"
 ? "Validar PIN actual"
 : "Confirmar nuevo PIN"}
 </h2>
...
function PinDigitField({
 ...
 return (
 <div>
 <label className="mb-3 block text-sm font-semibold text-[var(--ui-text)]">
 {label}
 </label>
 <input
 ref={inputRef}
 ...
 value[index] ? "text-cyan-200" : "text-[var(--ui-subtle)]"
 }`}
 >
 {value[index] ? "•" : index + 1}
 </span>
