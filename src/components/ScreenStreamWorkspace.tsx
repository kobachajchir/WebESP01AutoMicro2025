...
export default function ScreenStreamWorkspace({
 ...
 {!isModal && (
 <div>
 <h2 className="text-2xl font-black uppercase text-[var(--ui-text)]">
 Pantalla STM
 </h2>
 ...
 <p className="text-xl font-black text-[var(--ui-text)]">{screenLabel}</p>
 <p className="mt-1 text-sm text-[var(--ui-muted)]">
 ...
 <span className="font-bold text-[var(--ui-text)]">{itemsCount}</span>{" "}
 items distribuidos en{" "}
 <span className="font-bold text-[var(--ui-text)]">{totalPages}</span>{" "}
 páginas.
 </p>
 </div>
 )
 ...
 <div className="flex items-center justify-center text-xs font-semibold uppercase text-[var(--ui-muted)]">
 ...
 {hoverInfo && (
 <div className="absolute left-1/2 top-full z-20 mt-2 -translate-x-1/2 whitespace-nowrap rounded-md border border-cyan-300/20 bg-[var(--ui-bg-0)] px-3 py-2 text-[11px] normal-case text-[var(--ui-muted)] shadow-lg">
 ...
 <div className="flex aspect-[2/1] w-full items-center justify-center rounded-md border border-cyan-300/30 bg-[var(--ui-bg-0)] px-4 text-center text-xs text-[var(--ui-muted)]">
 ...
 >
 <div
 className="flex flex-col justify-between rounded-xl border border-[var(--ui-ring)] bg-[var(--ui-bg-0)]/40 p-3"
 style={{
 height: `${previewHeight}px`,
 minHeight: `${previewHeight}px`,
 }}
 ...
 >
 <div
 className="screen-menu-item-selector flex flex-col items-center justify-between rounded-xl border border-[var(--ui-ring)] bg-[var(--ui-bg-0)]/40 p-2"
 style={{
 height: `${previewHeight}px`,
 minHeight: `${previewHeight}px`,
 }}
 ...
 <div
 className="flex flex-col items-center justify-between rounded-xl border border-[var(--ui-ring)] bg-[var(--ui-bg-0)]/40 p-2"
 style={{
 height: `${previewHeight}px`,
 minHeight: `${previewHeight}px`,
 }}
 ...
 : "border-cyan-300/20 bg-cyan-400/5 text-[var(--ui-muted)]"
 }`}
 >
 ...
 <div className="flex w-full flex-col items-center justify-center gap-3 rounded-xl border border-[var(--ui-ring)] bg-[var(--ui-bg-0)]/50 p-4">
 <div className="grid-cols-1 flex flex-wrap items-center justify-center gap-2 text-xs text-[var(--ui-muted)] md:grid-cols-3">
 <ScreenFact
 label="Codigo"
 value={currentScreen?.screenCodeHex ?? formatScreenCodeHex(0)}
 styles="app-dialog flex flex-row items-start gap-2 py-2 px-4 !w-fit rounded-md bg-[var(--ui-bg-1)]/50 border border-[var(--ui-ring)]"
 />
 ...
 {canUseSavedScreens ? (
 <section className="mt-4 flex flex-col gap-4 rounded-xl border border-[var(--ui-ring)] bg-[var(--ui-bg-0)]/45 p-4">
 ...
 <article
 key={screen.id}
 className="rounded-2xl border border-[var(--ui-ring)] bg-[var(--ui-bg-0)]/55 p-3"
 >
 ...
 className="rounded-md border border-cyan-300/70 px-3 py-1.5 text-xs font-semibold text-cyan-200 transition hover:bg-cyan-400 hover:text-[var(--ui-ink)] disabled:cursor-not-allowed disabled:opacity-45 disabled:hover:bg-transparent disabled:hover:text-cyan-200"
 >
 Mandar
 </button>
 </div>
 ...
 <div className="rounded-2xl border border-dashed border-[var(--ui-ring)] bg-[var(--ui-bg-0)]/35 px-4 py-5 text-sm text-[var(--ui-muted)]">
...
function PillWithTooltip({
 ...
 <div className="pointer-events-none absolute left-1/2 top-full z-20 mt-2 hidden -translate-x-1/2 whitespace-nowrap rounded-md border border-cyan-300/20 bg-[var(--ui-bg-0)] px-3 py-2 text-[11px] normal-case text-[var(--ui-muted)] shadow-lg group-hover:block">
 {tooltip}
 </div>
 </div>
 );
...
function ScreenFact({
 ...
 <span className="block font-semibold uppercase text-[var(--ui-subtle)]">
 {label}
 </span>
 <span className="break-words font-mono text-[var(--ui-text)]">{value}</span>
 </div>
 );
}
