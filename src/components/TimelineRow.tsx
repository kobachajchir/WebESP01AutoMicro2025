...
function timelineToneClass(kind: BlockKind, highlighted: boolean, active: boolean) {
 ...
 ? {
 ramp: "border-amber-200 bg-amber-500 text-[var(--ui-text)] shadow-[0_0_0_2px_rgba(251,191,36,0.22),0_14px_30px_rgba(245,158,11,0.28)]",
 hold: "border-emerald-200 bg-emerald-500 text-[var(--ui-text)] shadow-[0_0_0_2px_rgba(52,211,153,0.22),0_14px_30px_rgba(16,185,129,0.26)]",
 pivot: "border-sky-200 bg-sky-500 text-[var(--ui-text)] shadow-[0_0_0_2px_rgba(56,189,248,0.22),0_14px_30px_rgba(14,165,233,0.26)]",
 arc: "border-indigo-200 bg-indigo-500 text-[var(--ui-text)] shadow-[0_0_0_2px_rgba(129,140,248,0.22),0_14px_30px_rgba(99,102,241,0.28)]",
 stop: "border-rose-200 bg-rose-500 text-[var(--ui-text)] shadow-[0_0_0_2px_rgba(251,113,133,0.22),0_14px_30px_rgba(244,63,94,0.28)]",
 }
 : {
...
function SortableBlock({
 ...
 className="app-input w-full rounded-md px-1 py-0.5 text-center text-xs text-[var(--ui-text)]"
 autoFocus
 />
 ) : (
 <div
 className="w-full truncate rounded-md px-1 text-center text-sm font-semibold text-[var(--ui-text)] transition-colors hover:bg-[var(--ui-panel)]"
 ...
 {isActive && (
 <div className="absolute inset-x-1 top-1 z-20 flex items-center justify-between gap-1 rounded-md border border-cyan-200/70 bg-[var(--ui-bg-0)]/90 px-2 py-1 text-[9px] font-black text-cyan-100 shadow-[0_0_18px_rgba(34,211,238,0.45)] backdrop-blur-sm">
 ...
 <span className="shrink-0 tabular-nums text-[var(--ui-text)]">
 ...
 <div className="mt-1 h-2 w-full overflow-hidden rounded-full bg-[var(--ui-panel)] ring-1 ring-[var(--ui-ring)]">
 <div
 className={`h-full transition-all duration-300 ${
 isPast || isActive ? "bg-cyan-300" : "bg-[var(--ui-panel-hover)]"
 }`}
...
function TrackMetric({
 ...
 return (
 <div className="min-w-[112px] rounded-md border border-[var(--ui-ring)] bg-white/[0.04] px-3 py-2">
 <div className="text-[10px] uppercase tracking-wide text-[var(--ui-muted)]">
 {label}
 </div>
 <div className={active ? "text-sm font-black text-cyan-200" : "text-sm font-black text-[var(--ui-text)]"}>
 {value}
 </div>
 </div>
 );
...
function TimelineRow({
 ...
 !selectedId || !blocks.some((b) => b.id === selectedId)
 ? "border-cyan-300/16 bg-[var(--ui-bg-0)]/42"
 : ""
 }`}
 >
 ...
 <div>
 <h3 className="text-lg font-black uppercase tracking-wide text-[var(--ui-text)]">
 {title}
 </h3>
 ...
 >
 <div className="relative flex h-36 w-full items-end gap-2 overflow-x-auto rounded-md border border-[var(--ui-ring)] bg-[var(--ui-panel)] px-6 pb-2 pt-3">
 {/* Marcadores absolutos 100% / 0% a la izquierda */}
 <div className="pointer-events-none absolute left-1 top-12 text-[10px] text-[var(--ui-muted)]">
 100%
 </div>
 <div className="pointer-events-none absolute left-6 right-3 top-[4.75rem] border-t border-dashed border-[var(--ui-ring)]" />
 <div className="pointer-events-none absolute left-1 bottom-4 text-[10px] text-[var(--ui-muted)]">
 0%
 </div>
 ...
 return (
 <div
 className="flex items-center justify-between gap-3 rounded-md border border-cyan-200/70 bg-[var(--ui-bg-0)]/95 px-3 py-2 text-xs text-[var(--ui-text)] shadow-[0_20px_50px_rgba(0,0,0,0.55),0_0_24px_rgba(34,211,238,0.28)]"
 style={{
 ...
 <span className="mt-1 block text-[10px] text-[var(--ui-muted)]">
 {ab.durationMs} ms
 </span>
 </span>
 {ab.kind !== "stop" ? (
