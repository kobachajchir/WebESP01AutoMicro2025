    ...
    <div className="app-panel-strong w-full rounded-md border border-cyan-300/18 p-4">
      ...
      <div className="mt-4">
        <div className="relative w-full">
          <div className="absolute inset-0 rounded-md bg-gradient-to-b from-white/5 to-transparent" />
          <svg
...
function Row({
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <label className="w-20 text-xs text-slate-300">{label}</label>
      <input
        readOnly
        value={`${toFixedSafe(value, 1)}°`}
        className="app-input flex-1 rounded-md px-2 py-1.5 text-slate-100"
      />
    </div>
  );
}
